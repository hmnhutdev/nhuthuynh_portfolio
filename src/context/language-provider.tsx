...
const translations = {
  en: {
    ...
    "hero.description":
      "I build modern web applications with passion and attention to detail",
    ...
    "about.description":
      "I'm a passionate Web Developer with expertise in building modern web applications using React, Node.js, CakePHP and other cutting-edge technologies.",
    ...
    "projects.description":
      "Key projects I've worked on during my professional career",
    "projects.role": "Role",
    ...
    "projects.hotelBooking": {
      title: "Hotel & Restaurant Booking System",
      role: "Frontend Developer",
      description: "A full-featured hotel and restaurant booking platform",
      achievements: [
        "Developed responsive UIs from design mockups using Vue.js",
        "Integrated RESTful APIs with a Python backend to enable dynamic data handling",
        "Conducted manual testing, documented issues, and delivered client-driven fixes",
      ],
    },
    "projects.chatSystem": {
      ...
      description:
        "A comprehensive customer support chat system with real-time communication capabilities.",
      achievements: [
    ...
    "projects.databaseMgmt": {
      ...
      role: "Frontend Developer",
      description: "Enterprise-level database management system",
      achievements: [
    ...
    "projects.hydroPlant": {
      ...
      role: "Frontend Developer",
      description:
        "Monitoring and management system for hydroelectric power plants with real-time data visualization.",
      achievements: [
  ...
  vi: {
    ...
    "hero.role": "Lập trình viên Web",
    "hero.description":
      "Tôi xây dựng các ứng dụng web hiện đại với đam mê và sự tỉ mỉ",
    ...
    "about.title": "Về Tôi",
    "about.description":
      "Tôi là một lập trình viên Web đầy nhiệt huyết với chuyên môn xây dựng các ứng dụng web hiện đại bằng React, Node.js, CakePHP và các công nghệ tiên tiến khác.",
    ...
    "projects.description":
      "Các dự án chính tôi đã tham gia trong quá trình làm việc",
    ...
    "projects.hotelBooking": {
      title: "Hệ Thống Đặt Phòng Khách Sạn & Nhà Hàng",
      role: "Lập Trình Viên Frontend",
      description:
        "Nền tảng đặt phòng khách sạn và nhà hàng với đầy đủ tính năng",
      achievements: [
        "Phát triển giao diện người dùng đáp ứng từ bản thiết kế mockup sử dụng Vue.js",
        "Tích hợp RESTful API với backend Python để xử lý dữ liệu động",
        "Thực hiện kiểm thử thủ công, ghi chép vấn đề và cung cấp các bản sửa lỗi theo yêu cầu khách hàng",
      ],
    },
    "projects.chatSystem": {
      ...
      description:
        "Hệ thống chat hỗ trợ khách hàng với khả năng giao tiếp thời gian thực.",
      achievements: [
    ...
    "projects.databaseMgmt": {
      ...
      role: "Lập Trình Viên Frontend",
      description:
        "Hệ thống quản lý cơ sở dữ liệu cấp doanh nghiệp với giao diện đáp ứng và hiển thị dữ liệu thời gian thực.",
      achievements: [
    ...
    "projects.hydroPlant": {
      ...
      role: "Lập trình viên Frontend",
      description:
        "Hệ thống giám sát và quản lý nhà máy thủy điện với hiển thị dữ liệu thời gian thực.",
      achievements: [
    ...
    try {
      ...
      for (const k of keys) {
        if (current && typeof current === "object" && k in current) {
          ...
          console.warn(
            `[${language}] Translation key '${key}' not found, using fallback: '${fallback}'`
          );
          return fallback;
        }
      }
